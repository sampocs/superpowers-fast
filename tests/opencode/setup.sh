...
#   $OPENCODE_CONFIG_DIR/superpowers-fast/             ← package root
#   $OPENCODE_CONFIG_DIR/superpowers-fast/skills/      ← skills dir (../../skills from plugin)
#   $OPENCODE_CONFIG_DIR/superpowers-fast/.opencode/plugins/superpowers-fast.js ← plugin file
#   $OPENCODE_CONFIG_DIR/plugins/superpowers-fast.js   ← symlink OpenCode reads

SUPERPOWERS_DIR="$OPENCODE_CONFIG_DIR/superpowers-fast"
SUPERPOWERS_SKILLS_DIR="$SUPERPOWERS_DIR/skills"
SUPERPOWERS_PLUGIN_FILE="$SUPERPOWERS_DIR/.opencode/plugins/superpowers-fast.js"
...
cp "$REPO_ROOT/.opencode/plugins/superpowers-fast.js" "$SUPERPOWERS_PLUGIN_FILE"

# Register plugin via symlink (what OpenCode actually reads)
mkdir -p "$OPENCODE_CONFIG_DIR/plugins"
ln -sf "$SUPERPOWERS_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/superpowers-fast.js"
...
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/superpowers-fast.js"
